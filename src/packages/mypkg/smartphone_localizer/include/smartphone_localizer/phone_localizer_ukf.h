...
#define UKF_IMU_R_STANDARD_DEVIATION 1.0
#define UKF_GNSSRAW_V_STANDARD_DEVIATION 0.1
#define UKF_GNSSRAW_R_STANDARD_DEVIATION 3*M_PI/180                      //
...
public:
    ...
    void imu2rpy(const sensor_msgs::Imu &imu, double* roll,double* pitch,double* yaw);
