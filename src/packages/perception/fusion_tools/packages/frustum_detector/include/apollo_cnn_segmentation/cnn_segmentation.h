...
private:
  ...
  int width_;
  int height_;
  std_msgs::Header message_lidar_header_;
  ...
  // subscriber
  ros::Subscriber frustum_points_sub_;
  ...
  void frustumPointsCallback(const autoware_msgs::DetectedObjectArray::ConstPtr &msg);
