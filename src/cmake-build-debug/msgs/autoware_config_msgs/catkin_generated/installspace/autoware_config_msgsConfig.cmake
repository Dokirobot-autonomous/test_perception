...
if("FALSE" STREQUAL "TRUE")
  set(autoware_config_msgs_SOURCE_PREFIX /home/ohashi/test_perception/src/msgs/autoware_config_msgs)
  set(autoware_config_msgs_DEVEL_PREFIX /home/ohashi/test_perception/src/cmake-build-debug/devel)
  ...
  set(autoware_config_msgs_INSTALL_PREFIX /usr/local)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'autoware_config_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
