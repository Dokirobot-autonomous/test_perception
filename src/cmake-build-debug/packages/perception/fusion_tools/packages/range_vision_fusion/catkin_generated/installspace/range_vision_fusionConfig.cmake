...
if("FALSE" STREQUAL "TRUE")
  set(range_vision_fusion_SOURCE_PREFIX /home/ohashi/test_perception/src/packages/perception/fusion_tools/packages/range_vision_fusion)
  set(range_vision_fusion_DEVEL_PREFIX /home/ohashi/test_perception/src/cmake-build-debug/devel)
  ...
  set(range_vision_fusion_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'range_vision_fusion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
...
set(depends "cv_bridge;sensor_msgs;image_transport;roscpp;tf;autoware_msgs;jsk_recognition_utils;eigen_conversions;tf_conversions;jsk_topic_tools;image_geometry;jsk_topic_tools")
