...
if("FALSE" STREQUAL "TRUE")
  set(lidar_apollo_cnn_seg_detect_SOURCE_PREFIX /home/ohashi/test_perception/src/packages/perception/lidar_detector/packages/lidar_apollo_cnn_seg_detect)
  set(lidar_apollo_cnn_seg_detect_DEVEL_PREFIX /home/ohashi/test_perception/src/cmake-build-debug/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lidar_apollo_cnn_seg_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
