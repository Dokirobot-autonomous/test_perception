...
if("FALSE" STREQUAL "TRUE")
  set(vision_darknet_detect_SOURCE_PREFIX /home/ohashi/test_perception/src/packages/perception/vision_detector/packages/vision_darknet_detect)
  set(vision_darknet_detect_DEVEL_PREFIX /home/ohashi/test_perception/src/cmake-build-debug/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vision_darknet_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
...
set(depends "cv_bridge;image_transport;roscpp;sensor_msgs;std_msgs;autoware_msgs;autoware_config_msgs")
