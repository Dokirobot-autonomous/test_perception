...
if("FALSE" STREQUAL "TRUE")
  set(libdpm_ttic_SOURCE_PREFIX /home/ohashi/test_perception/src/packages/perception/vision_detector/libs/dpm_ttic)
  set(libdpm_ttic_DEVEL_PREFIX /home/ohashi/test_perception/src/cmake-build-debug/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libdpm_ttic' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
