...
if("FALSE" STREQUAL "TRUE")
  set(vector_map_server_SOURCE_PREFIX /home/ohashi/test_perception/src/packages/data/packages/vector_map_server)
  set(vector_map_server_DEVEL_PREFIX /home/ohashi/test_perception/src/cmake-build-debug/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vector_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
...
set(depends "message_runtime;roscpp;geometry_msgs;autoware_msgs;vector_map_msgs;vector_map;visualization_msgs")
