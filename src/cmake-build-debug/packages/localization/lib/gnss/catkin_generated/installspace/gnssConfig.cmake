...
if("FALSE" STREQUAL "TRUE")
  set(gnss_SOURCE_PREFIX /home/ohashi/test_perception/src/packages/localization/lib/gnss)
  set(gnss_DEVEL_PREFIX /home/ohashi/test_perception/src/cmake-build-debug/devel)
  set(gnss_INSTALL_PREFIX "")
  set(gnss_PREFIX ${gnss_DEVEL_PREFIX})
else()
  set(gnss_SOURCE_PREFIX "")
  set(gnss_DEVEL_PREFIX "")
  set(gnss_INSTALL_PREFIX /usr/local)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gnss' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
